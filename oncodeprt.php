<?php
 ...
 if (isset($_GET['action']) && $_GET['action']=="new_ticket") {
    queryMysql("INSERT INTO `oncdb` (`id`, `entry_stamp`, `exit_stamp`) VALUES (NULL, CURRENT_TIMESTAMP, NULL);");
    $result=queryMysql("SELECT * FROM oncdb ORDER BY id DESC;");
...
<h1></h1>
<br><br>
<a href="oncodeprt.php?action=new_ticket"  class="button" onclick="printDiv('printTable')" value="print a div!" >
    <br><br><br><br>
request ticket
<br><br><br><br>
</button></a>
...
<div id="printTable">
        <?php
            echo "ticket Number: O".$ticket_number;
