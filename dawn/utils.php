...
function searchPatients($term){
  $search_query="SELECT * from patients WHERE patients.firstname LIKE '%".$term."%' OR patients.lastname LIKE '%".$term."%' OR patients.reg_no=".(int)$term.";";
  
  return queryMysql($search_query);
}
