<?php
 ...
 if (isset($_GET['action']) && $_GET['action']=="new_ticket") {
    queryMysql("INSERT INTO `micrdb` (`id`, `entry_stamp`, `exit_stamp`) VALUES (NULL, CURRENT_TIMESTAMP, NULL);");
    $result=queryMysql("SELECT * FROM micrdb ORDER BY id DESC;");
...
<br>
A head microbiology consultant and team of microbiologists test patient samples 
...
<h1></h1>
<br><br>
<a href="microdeprt.php?action=new_ticket"  class="button" onclick="printDiv('printTable')" value="print a div!" >
    <br><br><br><br>
request ticket
<br><br><br><br>
</button></a>
