<?php
 ...
 if (isset($_GET['action']) && $_GET['action']=="new_ticket") {
    queryMysql("INSERT INTO `phydb` (`id`, `entry_stamp`, `exit_stamp`) VALUES (NULL, CURRENT_TIMESTAMP, NULL);");
    $result=queryMysql("SELECT * FROM phydb ORDER BY id DESC;");
...
<h1></h1>
<br><br>
<a href="phamdeprt.php?action=new_ticket"  class="button" onclick="printDiv('printTable')" value="print a div!" >
    <br><br><br><br>
request ticket
<br><br><br><br>
</button></a>
...
<div id="printTable">
        <?php
            echo "ticket Number: PH".$ticket_number;
