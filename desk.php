  ...
  if (isset($_POST["send"]))
{
  $username = trim($_SESSION["username"]); 
   ...
   $query = "INSERT INTO desk (  username ) values ('$username')";
...
<div class="card">
           ...
           <h5>----><?php echo $tickets_remaining;  ?>----Tickets remaining </h5>
            ...
            <a href="desk.php?action=new_patient" ><form action="" method="post" >
     Call Next ticket
        
       
        <input class="btn btn-success" type="submit" name="send" value="send"  id="send"  >
    ...
    <div class="card">
                    <div class="card-body">
                        <div class="stat-widget-one">
                            <div class="stat-content dib">
                            <a href="regpage.php">.<button class="btn btn-success">register </button></a>
                            </div>
            </div>
    ...
    <center><h4>Print Ticket</h4></center>
          ...
          while($row = mysqli_fetch_assoc($result))
           {
              ...
              <div class='row'>
                <div class='col-md-2 col-lg-2'>
                 <h6>Name :</h6>". $row["lastname"]."</div>
                  <div class='col-md-2 col-lg-2'>
                     <h6>PhoneNumber :</h6>". $row["phonenumber"]. "</div>
                     <div class='col-md-2 col-lg-2'>
                        <h6>Reg No :</h6>".$row["reg_no"]."
                        </div>
              </div>";
          }
      }
